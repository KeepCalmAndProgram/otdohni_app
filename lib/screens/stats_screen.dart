...
class _StatsScreenState extends State<StatsScreen> {
  //late List<DataTable> _chartData;   beter version for initialization
  late List<DataModel> _chartData = getChartData(); // change to beter version
  ...
  void initState() {
    ...
    /*WidgetsBinding.instance.addPostFrameCallback(
      (_) async {
        _chartData = getChartData();   // initialization _chartData but I have a some error :(
      },
    );*/
  }
